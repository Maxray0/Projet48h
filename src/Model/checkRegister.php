...
$schoolId = (int) htmlspecialchars($_POST['schoolId']);
...
function AddUser($email, $pass, $schoolId, $userType)
{
  ...
  $my_Insert_Statement = $my_Db_Connection->prepare('INSERT INTO user (Email, EncryptedPassword, Reservations, SchoolId, UserType) VALUES (:email, :pass, :resa, :schoolId, :userType)');
  $my_Insert_Statement->bindParam(':email', $email);
  $my_Insert_Statement->bindParam(':pass', $pass);
  $my_Insert_Statement->bindParam(':resa', $test);
